...
">
  ...
  ">
    ...
    <p style="
      font-size: 16px;
      color: ${success ? '#1E1310' : '#C44040'};
      line-height: 1.6;
      margin: 0;
    ">${message}</p>
    ${success ? `<p style="font-size: 13px; color: #8A7E75; margin-top: 24px;">Tu mapa sigue evolucionando. Pronto recibirás la próxima actualización.</p>` : ''}
  </div>
</body>
</html>`
